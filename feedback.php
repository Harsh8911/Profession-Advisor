...
if (isset($_POST['insert'])) {
    ...
    if (!empty($name) && !empty($phone) && !empty($content)) {
        ...
        if ($result) {
            $msg = "<p class='alert alert-success'>Feedback Submit Successfully</p> ";
        } else {
            $error = "<p class='alert alert-warning'>Feedback Not submit Successfully</p> ";
        }
    } else {
        ...
        <div class="row">
            ...
            <div class="full-row">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="text-secondary double-down-line text-center">Feedback</h2>
                        </div>
                    </div>
